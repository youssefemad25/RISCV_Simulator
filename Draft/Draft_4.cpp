...
void SH(int rs1, int rs2, int offset)
{
    ...
    store_content(address2,content2);
    progcount++;
    cout<<"SH: Content of halfword R"<<rs1<<" is stored in the memory with an offset of "<<offset<<endl;
    cout << "Updated Program Count: " << progcount  << endl;
    }
}
...
void SB(int rs1, int rs2, int offset)
{
    ...
    store_content(address1,content1);
    progcount++;
    cout<<"SB: Content of R"<<rs1<<" is stored in the memory with an offset of "<<offset<<endl;
    cout << "Updated Program Count: " << progcount  << endl;
   }
}
...
int main()
{
    ...
    Sim(commands,result);
    string outputfilepath="/Users/youssefibrahim/Desktop/1/test.txt";
